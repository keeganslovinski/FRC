...
public class Robot extends TimedRobot {
    ...
    public void teleopInit() {
        if (robotContainer.getNavX() != null) {
    ...
    public void teleopPeriodic() {
        ...
        // Speed scaling based on left trigger (Generic logic preserved)
        ...
        double mechanismY = -robotContainer.getElevatorController().getLeftY();
    ...
    public void autonomousPeriodic() {
        ...
        // Simple time-based auto example
        if (elapsed < 2.0) {
